...
const KURTOS = [
    [
        ...
        2,
        0.8,
        "Cereale cu gluten (grâu), ouă, lapte",
        "",
    ],
    [
        "Kürtős Scorțișoară",
    ...
    [
        ...
        3,
        0.8,
        "Cereale cu gluten (grâu), ouă, lapte, fructe cu coajă lemnoasă (nucă)",
        "",
    ],
    [
        "Kürtős Nucă cu Scorțișoară",
        448,
        19,
        5,
        61,
    ...
    [
        ...
        3,
        0.8,
        "Cereale cu gluten (grâu), ouă, lapte, fructe cu coajă lemnoasă (fistic)",
        "",
    ],
    [
        "Kürtős Oreo",
        ...
        2.5,
        0.9,
        "Cereale cu gluten (grâu), ouă, lapte, soia",
        "",
    ],
];
...
const KURTOS_UMPLUT = [
    [
        ...
        3,
        0.7,
        "Cereale cu gluten (grâu), ouă, lapte, soia, fructe cu coajă lemnoasă (alune de pădure)",
        "conține cocos",
    ],
    [
        "Kürtős Umplut Dubai",
        ...
        3,
        0.7,
        "Cereale cu gluten (grâu), ouă, lapte, soia, fructe cu coajă lemnoasă (fistic, alune de pădure)",
        "",
    ],
    [
        "Kürtős Umplut Raffaello",
        470,
        24,
        14,
        58,
        ...
        3,
        0.7,
        "Cereale cu gluten (grâu), ouă, lapte, soia, fructe cu coajă lemnoasă (migdale)",
        "conține cocos",
    ],
    [
        "Kürtős Umplut Nucă cu Nutella",
        465,
        23,
        8,
        58,
        ...
        3,
        0.7,
        "Cereale cu gluten (grâu), ouă, lapte, soia, fructe cu coajă lemnoasă (nucă, alune de pădure)",
        "",
    ],
    [
        "Kürtős Umplut Nucă cu Zmeură",
        445,
        19,
        6,
        61,
    ...
    [
        "Kürtős Umplut Fistic cu Zmeură",
        440,
        18,
        6,
        62,
    ...
    [
        "Kürtős Umplut Fistic cu Ciocolată Albă",
        460,
        21,
        9,
        60,
        ...
        3,
        0.7,
        "Cereale cu gluten (grâu), ouă, lapte, soia, fructe cu coajă lemnoasă (fistic)",
        "",
    ],
];
...
const LANGOS = [
    ...
    [
        ...
        2.5,
        1.0,
        "Cereale cu gluten (grâu), lapte, soia, fructe cu coajă lemnoasă (alune de pădure)",
        "",
    ],
    [
        "Langoș Țărănesc",
        ...
        2,
        1.5,
        "Cereale cu gluten (grâu), lapte, muștar",
        "",
    ],
    [
        "Langoș Haiducesc",
    ...
    [
        ...
        2,
        1.6,
        "Cereale cu gluten (grâu), lapte, sulfiți (oțet balsamic)",
        "posibil fructe cu coajă lemnoasă (pesto) și fistic (mortadella)",
    ],
];

// per 100 ml
const BAUTURI = [
    ["Pepsi", 42, 0, 0, 11, 11, 0, 0, 0, "—", "doză 330 ml · conține cofeină"],
    [
        "Pepsi Max",
        0.3,
        0,
        ...
        0,
        "—",
        "doză 330 ml · conține cofeină și îndulcitori",
    ],
    ["Mirinda", 40, 0, 0, 10, 10, 0, 0, 0, "—", "doză 330 ml"],
    ["7Up", 37, 0, 0, 9, 9, 0, 0, 0, "—", "doză 330 ml"],
    ["Apă plată / minerală", 0, 0, 0, 0, 0, 0, 0, 0, "—", "sticlă 500 ml"],
    [
        "Espresso (scurt / lung / dublu)",
        2,
        0,
        0,
        0.3,
        ...
        0,
        "—",
        "cafea 30–60 ml · conține cofeină",
    ],
    [
        "Cafea la pahar (americano)",
        3,
        0,
        0,
        0.5,
        ...
        0,
        "—",
        "pahar 240 ml (8 oz) ≈ 7 kcal · conține cofeină",
    ],
    [
        "Latte",
        55,
        ...
        0.1,
        "Lapte",
        "pahar 240 ml (8 oz) ≈ 132 kcal · conține cofeină",
    ],
    [
        "Ceai (neîndulcit)",
        1,
    ...
    [
        ...
        0.15,
        "Lapte, soia",
        "pahar 240 ml (8 oz) ≈ 264 kcal · posibil ouă (bezele)",
    ],
];
    ...
    return (
        ...
        >
            <div className="mx-auto max-w-6xl px-4 pb-8 pt-32">
                ...
                <Section
                    title="Băuturi"
                    unit="per 100 ml — băuturile calde se servesc la pahar de 240 ml (8 oz)"
                    rows={BAUTURI}
                />
